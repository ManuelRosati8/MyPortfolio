      ...
      {project && (
        ...
        >
          ...
          >
            ...
            <div className="p-8">
              <motion.h2 className="text-3xl font-bold text-white mb-2">{project.title}</motion.h2>
              ...
              <motion.p className="text-neutral-200 mb-6">{project.longDescription}</motion.p>
